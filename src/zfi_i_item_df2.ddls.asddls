...
define view entity ZFI_I_ITEM_DF2
  as select from zfi_db_item  
  inner join zfi_db_root on zfi_db_item.paymentorder = zfi_db_root.paymentorder


//  association to parent ZFI_PYMBATCH_LINE as _Items on  _Items.Paymentorder = $projection.Paymentorder
