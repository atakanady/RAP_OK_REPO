...
define view entity ZFI_PYBATCH_TRANSLINE
  as select from zfi_pymbtch_line
  association        to parent ZFI_PYBATCH_TRANS as _Parent on  $projection.Paymentbatch = _Parent.Paymentbatch

  composition [1..*] of ZFI_PYBATCH_TRANSITEM           as _TransferItem
